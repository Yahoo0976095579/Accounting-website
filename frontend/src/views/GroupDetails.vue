...
<template>
  <div class="container mx-auto p-4 sm:p-6 lg:p-8">
    ...
    <div class="flex flex-row items-center justify-between mb-6 space-x-2">
      ...
      <button
        @click="$router.back()"
        class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-1 rounded transition duration-200 ease-in-out text-sm sm:text-base flex-grow sm:flex-grow-0"
      >
        ← 返回我的群組
      </button>
